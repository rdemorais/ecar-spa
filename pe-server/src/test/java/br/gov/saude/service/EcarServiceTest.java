...
public class EcarServiceTest {
	...
	public void testFiltroEstruturaMetaIniListaItens() {
		FiltroDto filtro = new FiltroDto();
		filtro.setCodExe(1L);
		List<ItemDto> listaItens = ecarSiteService.loadListaItens(filtro, Estrutura.META, false, false);
		/*
	...
	public void testFiltroEstruturaProdutoListaItens() {
		...
		List<ItemDto> listaItens = ecarSiteService.loadListaItens(filtro, Estrutura.PRODUTO_INTERMEDIARIO, false, false);
	...
	public void testFiltroEstruturaAtividadeListaItens() {
		...
		List<ItemDto> listaItens = ecarSiteService.loadListaItens(filtro, Estrutura.ATIVIDADE, false, false);
	...
	public void testFiltroPorSecretaria() {
		...
		List<ItemDto> listaItens = ecarSiteService.loadListaItens(filtro, Estrutura.INICIATIVA, false, false);
